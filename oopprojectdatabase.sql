...
-- Dumping structure for table oopproject.songs
...
-- Dumping data for table oopproject.songs: ~670 rows (approximately)
/*!40000 ALTER TABLE `songs` DISABLE KEYS */;
INSERT INTO `songs` (`ID`, `Title`, `Artist`, `Genre`, `Year`, `Location`, `Duration`) VALUES
	...
	(55, 'THE MAN WHO PLAYS THE MANDOLINO', 'DEAN MARTIN', '2000s', '1957', 'Dean Martin-The Man Who Plays The Mandolino.mp3', 169),
	(56, 'CUMBERLAND GAP', 'VIPERS SKIFFLE GROUP, THE', 'CLASSICAL', '1957', 'Vipers Skiffle Group, The-Cumberland Gap.mp3', 116),
	...
	(96, 'ANOTHER SLEEPLESS NIGHT', 'JIMMY CLANTON', '1970s', '1961', 'Jimmy Clanton-Another Sleepless Night.mp3', 130),
...
-- Dumping structure for table oopproject.songs_copy
CREATE TABLE IF NOT EXISTS `songs_copy` (
  `ID` int(10) DEFAULT NULL,
  `Title` varchar(255) DEFAULT NULL,
  `Artist` varchar(255) DEFAULT NULL,
  `Genre` varchar(50) DEFAULT NULL,
...
-- Dumping data for table oopproject.songs_copy: ~670 rows (approximately)
/*!40000 ALTER TABLE `songs_copy` DISABLE KEYS */;
INSERT INTO `songs_copy` (`ID`, `Title`, `Artist`, `Genre`, `Year`, `Location`, `Duration`) VALUES
	(1, 'HERE IN MY HEART', 'AL MARTINO', 'POP', '1952', 'Al Martino-Here In My Heart.mp3', 183),
	(2, 'CHANGING PARTNERS', 'BING CROSBY', 'MOTOWN & SOUL', '1952', 'Bing Crosby-Changing Partners.mp3', 166),
	(3, 'SILENT NIGHT HOLY NIGHT', 'BING CROSBY', 'POP', '1952', 'Bing Crosby-Silent Night Holy Night.mp3', 160),
	(4, 'YOU BELONG TO ME', 'JO STAFFORD', 'COUNTRY', '1952', 'Jo Stafford-You Belong To Me.mp3', 191),
	...
	(669, 'I\'LL BE THERE', 'JESS GLYNNE', 'ROCK & ROLL', '2018', 'Jess Glynne-I\'ll Be There.mp3', 193),
	(670, 'HOW WE DO (PARTY)', 'RITA ORA', 'POP', '2018', 'Rita Ora-How We Do (Party).mp3', 247);
/*!40000 ALTER TABLE `songs_copy` ENABLE KEYS */;
